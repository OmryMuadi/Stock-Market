...
//        if marketHoursService.isMarketOpen() == false:
//        return
//
...
//
//        randomPercent = random number between -0.02 and +0.02
//        newPrice = oldPrice * (1 + randomPercent)
//
//        if newPrice < 1:
//        newPrice = 1
//
//        stock.currentPrice = round(newPrice, 2)
...
//        )
//
//        priceHistoryRepository.save(pricePoint)
//
